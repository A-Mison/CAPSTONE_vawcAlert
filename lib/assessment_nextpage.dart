...
import 'package:vawc_alert_proj/assessment_nextpageA.dart';

class NextPage extends StatefulWidget {
  final List<String> previousAnswers;
  const NextPage({super.key, required this.previousAnswers});
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: Text(
                        'Naranasan mo na bang sigawan, insultuhin, o pagbantaan ng iyong asawa/kinakasama o kapamilya?',
                        style: TextStyle(
                          fontFamily: 'Inter',
                          ...
                          child: ElevatedButton(
                            onPressed: _selectedOption == null
                              ...
                              Navigator.of(context).push(
                                MaterialPageRoute(
                                  builder: (_) => NextPageA(previousAnswers: updatedAnswers),
                                ),
                              );
                            },
