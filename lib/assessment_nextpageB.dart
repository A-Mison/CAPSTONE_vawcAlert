...
import 'package:vawc_alert_proj/assessment_nextpageC.dart';

class NextPageB extends StatefulWidget {
  final List<String> previousAnswers;
  const NextPageB({super.key, required this.previousAnswers});

  @override
  State<NextPageB> createState() => _NextPageBState();
}

class _NextPageBState extends State<NextPageB> {
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: Text(
                        'Ikaw ba ay pinipilit sa mga bagay na ayaw mong gawin, tulad ng pakikipagtalik o gawaing bahay, kahit hindi ka handa o labag sa iyong loob?',
                        style: TextStyle(
                          fontFamily: 'Inter',
                          ...
                          child: ElevatedButton(
                            onPressed: _selectedOption == null
                              ...
                              Navigator.of(context).push(
                                MaterialPageRoute(
                                  builder: (_) => NextPageC(previousAnswers: updatedAnswers),
                                ),
                              );
                            },
