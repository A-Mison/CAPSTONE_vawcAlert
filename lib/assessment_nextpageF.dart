...
class NextPageF extends StatefulWidget {
  const NextPageF({super.key});

  @override
  State<NextPageF> createState() => _NextPageFState();
}

class _NextPageFState extends State<NextPageF> {
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: Text(
                        'Nakaranas ka na bang ipagbawal o limitahan ang iyong pag-aaral o pagtatrabaho para mawalan ka ng kalayaan?',
                        style: TextStyle(
                          fontFamily: 'Inter',
                          ...
                          child: ElevatedButton(
                            onPressed: _selectedOption == null
                              ...
                              Navigator.of(context).push(
                                MaterialPageRoute(builder: (_) => const NextPageG()),
                              );
                            },
