...
import 'package:vawc_alert_proj/result_assessment.dart';
import 'package:vawc_alert_proj/assessment_nextpageG.dart';

class NextPageH extends StatefulWidget {
  const NextPageH({super.key});

  @override
  State<NextPageH> createState() => _NextPageHState();
}

class _NextPageHState extends State<NextPageH> {
  ...
  void _onNextPressed() {
    ...
    final updatedAnswers = List<String>.from(widget.previousAnswers)..add(_selectedOption!);

    // THIS IS THE FINAL NAVIGATION — show result page with all answers
    Navigator.of(context).push(
      MaterialPageRoute(builder: (_) => ResultPage( previousAnswers: updatedAnswers)),
    );
  }
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: Text(
                        'Nakaramdam ka na ba ng matinding takot o pagkabalisa dahil sa ugali o kilos ng iyong asawa/kinakasama o kapamilya?',
                        style: TextStyle(
                          fontFamily: 'Inter',
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            onPressed: _selectedOption == null
                                ...
                                : () {
                              Navigator.of(context).push(
                                MaterialPageRoute(builder: (_) => const NextPageH()),
                              );
                            },
