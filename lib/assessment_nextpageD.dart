...
import 'package:vawc_alert_proj/assessment_nextpageE.dart';

class NextPageD extends StatefulWidget {
  const NextPageD({super.key});

  @override
  State<NextPageD> createState() => _NextPageDState();
}

class _NextPageDState extends State<NextPageD> {
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: Text(
                        'Nakaranas ka na ba ng pananakit pisikal tulad ng sampal, suntok, tadyak, o paghagis ng bagay laban sa iyo?',
                        style: TextStyle(
                          fontFamily: 'Inter',
                          ...
                          child: ElevatedButton(
                            onPressed: _selectedOption == null
                              ...
                              Navigator.of(context).push(
                                MaterialPageRoute(builder: (_) => const NextPageE()),
                              );
                            },
