...
class AssessmentPage extends StatefulWidget {
  ...
  const AssessmentPage({super.key, this.previousAnswers = const []});
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: Text(
                        'May pagkakataon ba na pinipigilan ka ng iyong asawa/kinakasama o kapamilya sa pakikipag-ugnayan sa mga kaibigan o kamag-anak?',
                        style: TextStyle(
                          fontFamily: 'Inter',
                          ...
                          child: ElevatedButton(
                            onPressed: _selectedOption == null
                              ...
                              Navigator.of(context).push(
                                MaterialPageRoute(
                                  builder: (_) => NextPage(previousAnswers: updatedAnswers),
                                ),
                              );
                            },
