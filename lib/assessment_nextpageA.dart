...
import 'package:vawc_alert_proj/assessment_nextpageB.dart';

class NextPageA extends StatefulWidget {
  final List<String> previousAnswers;
  const NextPageA({super.key, required this.previousAnswers});

  @override
  State<NextPageA> createState() => _NextPageAState();
}

class _NextPageAState extends State<NextPageA> {
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: Text(
                        'May pagkakataon ba na pinapahiya ka sa harap ng ibang tao?',
                        style: TextStyle(
                          fontFamily: 'Inter',
                          ...
                          child: ElevatedButton(
                            onPressed: _selectedOption == null
                              ...
                              Navigator.of(context).push(
                                MaterialPageRoute(
                                  builder: (_) => NextPageB(previousAnswers: updatedAnswers),
                                ),
                              );
                            },
