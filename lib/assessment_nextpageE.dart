...
import 'package:vawc_alert_proj/assessment_nextpageF.dart';

class NextPageE extends StatefulWidget {
  const NextPageE({super.key});

  @override
  State<NextPageE> createState() => _NextPageEState();
}

class _NextPageEState extends State<NextPageE> {
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: Text(
                        'May pagkakataon ba na tinatakot kang iwanan, palayasin, o ipagkait ang mga anak mo kung hindi ka susunod sa kagustuhan nila?',
                        style: TextStyle(
                          fontFamily: 'Inter',
                          ...
                          child: ElevatedButton(
                            onPressed: _selectedOption == null
                              ...
                              Navigator.of(context).push(
                                MaterialPageRoute(builder: (_) => const NextPageF()),
                              );
                            },
